"""Core rhyme query orchestration utilities."""
...
class RhymeQueryOrchestrator:
    """Coordinates rhyme discovery across analyzers and repositories."""
    ...
    def __init__(
        ...
        *,
        ...
        if phonetic_analyzer is not None:
            self.cmu_repository.set_analyzer(phonetic_analyzer)
    ...
    def set_phonetic_analyzer(self, analyzer: Optional[EnhancedPhoneticAnalyzer]) -> None:
        ...
        if analyzer is not None and getattr(analyzer, "cmu_loader", None):
            ...
            self.cmu_repository.update_resources(loader=self.cmu_loader)
    ...
    def _lookup_cmu_rhymes(
        ...
        repository = self.cmu_repository
        cache_key = (
            source_word,
            int(limit),
        ...
        try:
            results = repository.fetch_rhymes(
                source_word,
                limit=limit,
                analyzer=analyzer,
